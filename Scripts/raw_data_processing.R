...
# 4
  ...
  df_thc4 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(4, 0, 2000) # no blips!
...
# 5
  ...
  df_thc5 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(5, 0, 2000) # no blips!
...
# 6
  ...
  df_thc6 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(6, 0, 2000) # no blips!
...
# 7
  ...
  df_thc7 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(7, 0, 2000) # no blips!
...
# 8
  ...
  df_thc8 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(8, 0, 2000) # no blips!
...
# 9
  ...
  df_thc9 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(9, 0, 2000) # no blips!
...
# 10
  ...
  df_thc10 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(10, 0, 2000) # no blips!
...
# 11
  ...
  df_thc11 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(11, 0, 2000) # no blips!
...
# 12
  ...
  df_thc12 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(12, 0, 2000) # no blips!
...
# 15
  ...
  df_thc15 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(15, 0, 2000) # no blips!
...
# 16
  ...
  df_thc16 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(16, 0, 2000) # no blips!
  df_thc16$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(16)
  df_o2sat16 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(16, 0, 1100)
...
# 17
  ...
  df_thc17 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(17, 0, 2000) # no blips!
...
# 18
  ...
  df_thc18 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(18, 0, 2000) # no blips!
  df_thc18$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(18)
  df_o2sat18 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(18, 0, 350)
...
# 19
  ...
  df_thc19 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(19, 0, 2000) # no blips!
...
# 20
  ...
  df_thc20 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(20, 0, 2000) # no blips!
  df_thc20$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(20)
  df_o2sat20 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(20, 0, 2000)
  df_o2sat20$O2_sat %>% var(na.rm = TRUE)
  
  
# 21
  # THC
  df_raw_data %>% f_plot_thc(21)
  df_thc21 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(21, 0, 2000) # no blips!
  df_thc21$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(21)
  df_o2sat21 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(21, 1250, 2000)
  df_o2sat21$O2_sat %>% var(na.rm = TRUE)
  
  
# 22
  # THC
  df_raw_data %>% f_plot_thc(22)
  df_thc22 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(22, 0, 2000) # no blips!
  df_thc22$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(22)
  df_o2sat22 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(22, 0, 2000)
  df_o2sat22$O2_sat %>% var(na.rm = TRUE)
  
  
# 23
  # THC
  df_raw_data %>% f_plot_pt(23)
  df_thc23 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(23, 1350, 2000)
  df_thc23$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(23)
  df_o2sat23 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(23, 1350, 2000)
  df_o2sat23$O2_sat %>% var(na.rm = TRUE)
  
  
# 25
  # THC
  df_raw_data %>% f_plot_pt(25)
  df_thc25 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(25, 0, 2000) # no blips!
  df_thc25$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(25)
  df_o2sat25 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(25, 300, 750) # very noisy signal
  df_o2sat25$O2_sat %>% mean(na.rm = TRUE)
  
  
# 26
  # THC
  df_raw_data %>% f_plot_thc(26)
  df_thc26 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(26, 0, 2000) # no blips!
  df_thc26$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(26)
  df_o2sat26 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(26, 0, 1000)
  df_o2sat26$O2_sat %>% var(na.rm = TRUE)
  

# 27
  # THC
  df_raw_data %>% f_plot_thc(27)
  df_thc27 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(27, 0, 2000) # no blips!
...
# 28
  ...
  df_thc28 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(28, 0, 2000) # no blips!
...
# 31
  ...
  df_thc31 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(31, 0, 2000) # no blips!
  df_thc31$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(31)
  df_o2sat31 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(31, 0, 2000)
...
# 32
  ...
  df_thc32 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(32, 0, 2000) # no blips!
...
# 33
  ...
  df_thc33 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(33, 0, 2000) # no blips!
  df_thc33$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(33)
  df_o2sat33 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(33, 0, 2000)
...
# 34
  ...
  df_thc34 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(34, 0, 430)
  df_thc34$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(34)
  df_o2sat34 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(34, 0, 400)
...
# 35
  ...
  df_thc35 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(35, 0, 510)
  df_thc35$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(35)
  df_o2sat35 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(35, 0, 510)
...
# 36
  ...
  df_thc36 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(36, 0, 2000) # no blips!
...
# 37
  ...
  df_thc37 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(37, 700, 2000)
  df_thc37$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(37)
  df_o2sat37 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(37, 700, 2000)
...
# 38
  ...
  df_thc38 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(38, 0, 2000) # no blips!
  df_thc38$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(38)
  df_o2sat38 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(38, 0, 2000)
...
# 39
  ...
  df_thc39 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(39, 0, 1100) 
  df_thc39$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(39)
  df_o2sat39 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(39, 310, 1000)
...
# 40
  ...
  df_thc40 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(40, 0, 2000) # no blips!
...
# 41
  ...
  df_thc41 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(41, 0, 2000) # no blips!
  df_thc41$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(41)
  df_o2sat41 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(41, 0, 900)
...
# 42
  ...
  df_thc42 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(42, 400, 2000)
  df_thc42$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(42)
  df_o2sat42 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(42, 400, 2000)
...
# 43
  ...
  df_thc43 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(43, 0, 2000) # no blips!
  df_thc43$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(43)
  df_o2sat43 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(43, 1440, 2000)
  df_o2sat43$O2_sat %>% var(na.rm = TRUE)
  
  
# 44
  # THC
  df_raw_data %>% f_plot_thc(44)
  df_thc44 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(44, 0, 2000) # no blips!
  df_thc44$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(44)
  df_o2sat44 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(44, 0, 2000)
  df_o2sat44$O2_sat %>% var(na.rm = TRUE)
  
  
# 45
  # THC
  df_raw_data %>% f_plot_thc(45)
  df_thc45 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(45, 0, 2000) # no blips!
  df_thc45$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(45)
  df_o2sat45 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(45, 0, 1000)
...
# 46
  ...
  df_thc46 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(46, 0, 2000) # no blips!
  df_thc46$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(46)
  df_o2sat46 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(46, 450, 2000)
...
# 47
  ...
  df_thc47 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(47, 0, 2000) # no blips!
  df_thc47$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(47)
  df_o2sat47 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(47, 200, 700)
  df_o2sat47$O2_sat %>% var(na.rm = TRUE)
  

# 48
  # THC
  df_raw_data %>% f_plot_thc(48)
  df_thc48 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(48, 200, 2000)
  df_thc48$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_o2sat48 %>% f_plot_o2sat(48) ### signal too noisy

  
# 49
  # THC
  df_raw_data %>% f_plot_thc(49)
  df_thc49 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(49, 350, 2000)
  df_thc49$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(49)
  df_o2sat49 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(49, 0, 300)
...
# 50
  ...
  df_thc50 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(50, 490, 2000)
  df_thc50$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(50)
  df_o2sat50 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(50, 490, 2000)
  df_o2sat50$O2_sat %>% var(na.rm = TRUE)
  
  
# 51
  # THC
  df_raw_data %>% f_plot_thc(51)
  df_thc51 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(51, 0, 2000) # no blips!
  df_thc51$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(51) ### signal too noisy

  
# 52
  # THC
  df_raw_data %>% f_plot_thc(52)
  df_thc52 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(52, 0, 2000) # no blips!
  df_thc52$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(52)
  df_o2sat52 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(52, 0, 1150) ### very noisy signal....
...
# 53
  ...
  df_thc53 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(53, 150, 2000)
  df_thc53$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(53)
  df_o2sat53 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(53, 150, 2000)
...
# 54
  ...
  df_thc54 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(54, 0, 2000) # no blips!
  df_thc54$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(54)
  df_o2sat54 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(54, 0, 1100)
...
# 55
  ...
  df_thc55 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(55, 0, 2000) # no blips!
...
# 56
  ...
  df_thc56 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(56, 0, 2100) # no blips!
...
# 57
  ...
  df_thc57 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(57, 0, 2000) # no blips!
...
# 58
  ...
  df_thc58 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(58, 700, 2000)
  df_thc58$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(58)
  df_o2sat58 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(58, 650, 2000)
...
# 59
  ...
  df_thc59 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(59, 0, 2000) # no blips!
  df_thc59$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(59)
  df_o2sat59 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(59, 0, 2000)
...
# 60
  ...
  df_thc60 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(60, 0, 2000) # no blips!
...
# 61
  ...
  df_thc61 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(61, 0, 2000) # no blips!
  df_thc61$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(61)
  df_o2sat61 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(61, 0, 2000)
...
# 62
  ...
  df_thc62 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(62, 0, 1150)
  df_thc62$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(62)
  df_o2sat62 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(62, 0, 1150)
...
# 63
  ...
  df_thc63 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(63, 1350, 2000)
  df_thc63$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(63)
  df_o2sat63 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(63, 1450, 2000)
  df_o2sat63$O2_sat %>% var(na.rm = TRUE)
  
  
# 64
  # THC
  df_raw_data %>% f_plot_thc(64)
  df_thc64 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(64, 0, 2000) # no blips!
  df_thc64$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(64)
  df_o2sat64 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(64, 0, 2000)
  df_o2sat64$O2_sat %>% var(na.rm = TRUE)
  
  
# 65
  # THC
  df_raw_data %>% f_plot_thc(65)
  df_thc65 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(65, 0, 1700)
  df_thc65$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(65)
  df_o2sat65 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(65, 0, 1700)
  df_o2sat65$O2_sat %>% var(na.rm = TRUE)
  
  
# 66
  # THC
  df_raw_data %>% f_plot_thc(66)
  df_thc66 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(66, 0, 2000) # no blips!
  df_thc66$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(66)
  df_o2sat66 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(66, 0, 2000)
...
# 67
  ...
  df_thc67 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(67, 0, 525)
  df_thc67$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(67)
  df_o2sat67 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(67, 0, 525)
...
# 68
  ...
  df_thc68 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(68, 1350, 1600)
  df_thc68$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_o2sat68 %>% f_plot_o2sat(68) ### signal too noisy

  
# 69
  # THC
  df_raw_data %>% f_plot_thc(69) # all negative??
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(69) ### signal too noisy


# 70
  # THC
  df_raw_data %>% f_plot_thc(70)
  df_thc70 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(70, 0, 1900)
  df_thc70$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(70)
  df_o2sat70 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(70, 0, 1800)
...
# 71
  ...
  df_thc71 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(71, 0, 2000) # no blips!
  df_thc71$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(71)
  df_o2sat71 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(71, 0, 2000)
...
# 72
  ...
  df_thc72 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(72, 0, 1400) 
  df_thc72$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(72)
  df_o2sat72 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(72, 0, 1400)
...
# 73
  ...
  df_thc73 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(73, 0, 2000) # no blips!
...
# 74
  ...
  df_thc74 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(74, 0, 2000) # no blips!
...
# 75
  ...
  df_thc75 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(75, 0, 1800)
  df_thc75$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(75)
  df_o2sat75 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(75, 800, 1500)
...
# 76
  ...
  df_thc76 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(76, 0, 2000) # no blips!
  df_thc76$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(76)
  df_o2sat76 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(76, 800, 2000)
...
# 77
  ...
  df_thc77 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(77, 0, 2000) # no blips!
...
# 78
  ...
  df_thc78 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(78, 0, 2000) # no blips!
...
# 79
  ...
  df_thc79 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(79, 0, 2000) # no blips!
...
# 80
  ...
  df_thc80 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(80, 0, 2000) # no blips!
...
# 81
  ...
  df_thc81 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(81, 0, 2000) # no blips!
...
# 82
  ...
  df_thc82 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(82, 0, 2000) # no blips!
...
# 83
  ...
  df_thc83 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(83, 0, 2000) # no blips!
...
# 84
  ...
  df_thc84 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(84, 0, 2000) # no blips!
...
# 85
  ...
  df_thc85 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(85, 0, 2000) # no blips!
...
# 86
  ...
  df_thc86 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(86, 0, 2000) # no blips!
...
# 87
  ...
  df_thc87 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(87, 0, 2000) # no blips!
...
# 88
  ...
  df_thc88 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(88, 0, 2000) # no blips!
...
# 89
  ...
  df_thc89 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(89, 0, 2000) # no blips!
...
# 90
  ...
  df_thc90 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(90, 0, 2000) # no blips!
  df_thc90$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(90)
  df_o2sat90 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(90, 0, 2000)
...
# 91
  ...
  df_thc91 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(91, 0, 2000) # no blips!
  df_thc91$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(91)
  df_o2sat91 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(91, 0, 2000)
...
# 92
  ...
  df_thc92 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(92, 0, 2000) # no blips!
...
# 93
  ...
  df_thc93 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(93, 0, 2000) # no blips!
...
# 94
  ...
  df_thc94 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(94, 0, 2000) # no blips!
  df_thc94$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(94)
  df_o2sat94 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(94, 300, 2000)
...
# 95
  ...
  df_thc95 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(95, 0, 2000) # no blips!
...
# 96
  # THC
  df_raw_data %>% f_plot_thc(96)
  df_thc96 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(96, 0, 2000) # no blips!
  df_thc96$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(96)
  df_o2sat96 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(96, 0, 2000)
  df_o2sat96$O2_sat %>% var(na.rm = TRUE)
  

# 97
  # THC
  df_raw_data %>% f_plot_thc(97)
  df_thc97 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(97, 0, 2000) # no blips!
  df_thc97$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(97)
  df_o2sat97 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(97, 0, 2000)
  df_o2sat97$O2_sat %>% var(na.rm = TRUE)
  
  
# 98
  # THC
  df_raw_data %>% f_plot_thc(98)
  df_thc98 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(98, 0, 2000) # no blips!
  df_thc98$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(98)
  df_o2sat98 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(98, 0, 2000)
  df_o2sat98$O2_sat %>% var(na.rm = TRUE)
  
  
# 99
  # THC
  df_raw_data %>% f_plot_thc(99)
  df_thc99 <- df_raw_data %>% dplyr::select(-O2_sat) %>% f_segment_signal(99, 0, 2000) # no blips!
  df_thc99$THC %>% var(na.rm = TRUE)
  
  # O2 sat
  df_raw_data %>% f_plot_o2sat(99)
  df_o2sat99 <- df_raw_data %>% dplyr::select(-THC) %>% f_segment_signal(99, 0, 2000)
  df_o2sat99$O2_sat %>% var(na.rm = TRUE)
...
# combine all  
  ...
  df_o2sat_filt <- bind_rows(df_o2sat1, df_o2sat2, df_o2sat3, df_o2sat6, df_o2sat7, df_o2sat8, df_o2sat9, df_o2sat10, #4, 5,  and 6 are all the exact same
                             ...
                             df_o2sat21, df_o2sat22, df_o2sat23, df_o2sat25, df_o2sat26, df_o2sat27, df_o2sat28,
                             df_o2sat31, df_o2sat32, df_o2sat33, df_o2sat34, df_o2sat35, df_o2sat36, df_o2sat37, df_o2sat38, df_o2sat39, df_o2sat40,
                             df_o2sat41, df_o2sat42, df_o2sat43, df_o2sat44, df_o2sat45, df_o2sat46, df_o2sat47, df_o2sat49, df_o2sat50,
                             df_o2sat52, df_o2sat53, df_o2sat54, df_o2sat55, df_o2sat56, df_o2sat57, df_o2sat58, df_o2sat59, df_o2sat60,
                             df_o2sat61, df_o2sat62, df_o2sat63, df_o2sat64, df_o2sat65, df_o2sat66, df_o2sat67, df_o2sat70,
                             ...
                             df_o2sat91, df_o2sat92, df_o2sat93, df_o2sat94, df_o2sat95, df_o2sat96, df_o2sat97, df_o2sat98, df_o2sat99)
